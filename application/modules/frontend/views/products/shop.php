        ...
        <div class="custom-width">
            ...
            <div class="artist-shortby">
                ...
                <span>
                    <div class="dropdown">
                        Sort By:
                        <button class="dropdown-toggle" type="button" data-toggle="dropdown">Name <?php 
            ...
            <div class="artist-list">
                <div class="row" id="default-datatable22s">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="artist-list-inner shop-details-page span shop-page-inner">
                            <?php if($val->banner_image==""){ ?>
                            <a href="<?php echo base_url();?>shopdetails/<?php echo  digi_encode(($val->id)); ?>">
                                <img src="<?php echo base_url(); ?>assets/front/images/Blank-Store-vedr02.jpg" class="img-responsive" /></a>
                            <?php }
                        else{
                            ?>
                            <a href="<?php echo base_url();?>shopdetails/<?php echo  digi_encode(($val->id)); ?>">
