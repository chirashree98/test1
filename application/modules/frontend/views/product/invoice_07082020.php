                                            ...
                                            <tbody>
                                                ...
                                                foreach ($ord_items->result() as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td >&#8364; <?php echo number_format((float) $row->box_prc, 2, ',', ''); ?> </td>
                                                        <td >&#8364; <?php echo number_format((float) $row->wash_prc, 2, ',', ''); ?> </td>
                                                        <td > &#8364; <?php
                                                            echo number_format(floatval(($row->box_prc + $row->wash_prc) * $row->order_qty), 2, ',', '');
                                                            $s_tot += floatval(($row->box_prc + $row->wash_prc) * $row->order_qty);
                                                            ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-card"> 
                                    ...
                                    <div class="row m-0 order-review">
                                        <div class="col-md-12"><h3>ORDERBEVESTIGING</h3></div>
                                        <div class="col-md-6">Ordernummer :  <strong><?php echo $ord_stng['id']; ?></strong></div>
                                        <div class="col-md-6 text-right">Datum :   <?php echo date(('d/m/Y'), strtotime($ord_stng['created_at'])); ?></div>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-inbox print-page mb-0">
                                            <thead>
                                    ...
                                    <div class="row m-0 order-review">
                                        <div class="col-md-12"><h3>Durafest BV</h3></div>
                                        <div class="col-md-6">
                                            <ul>
                                                <li>Wingepark 4A</li>
                                                <li></li>
                                            ...
                                            <ul>
                                                <li>3110ROTSELAAR</li>
                                                <li>Tel : 016/24 14 81</li>
                                            </ul>
                                        </div>
                                        <div class="col-md-6">
                                            <ul>
                                                <li>BTW BE 0479.870.579</li>
                                                <li>RPR leuven</li>
                                            </ul>
                                            <ul>
                                                <li>BIC : KREDBEBB</li>
                                                <li>IBAN : BE26 7350 0618 3029</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
