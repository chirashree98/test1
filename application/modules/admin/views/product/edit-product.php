                                    ...
                                    <div class="portlet-body">
                                        <form action="<?php echo base_url(); ?>admin/product_management/update_product" id="myFrm" method="post" class="horizontal-form" enctype="multipart/form-data">
                                           ...
                                           <!--<pre>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
														...
														<div class="form-group">
                                                            ...
                                                            <textarea   required="" name="long_description" id="long_description" class="form-control" placeholder=""><?php echo $query['long_description']; ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label>E-Store</label>
                                                    <textarea type="text"  required class="form-control" name="store_details"><?php echo $query['store_details']; ?></textarea>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
    ...
    foreach ($attr_value as $val) {
        ?>
                                                        ...
                                                        ?>  
                                                                                                                                                    ...
                                                                                                                                                    <input type="checkbox" <?php
                                                        if (in_array($val, $pro_attribute[$row->attr_name])) {
                                                            echo"checked";
                                                        }
