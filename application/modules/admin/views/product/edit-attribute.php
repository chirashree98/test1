                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered">
                                    <div class="portlet-title">
                                        <div class="caption"> <i class="icon-settings font-red"></i> <span class="caption-subject font-red sbold uppercase"> Edit Attribute</span> </div>
                                    </div>
                                    <div class="portlet-body">
                                        <form action="" id="myFrm" method="post" class="horizontal-form aditattribute" enctype="multipart/form-data">
                                            <input type="hidden" value="<?php echo $query['id']; ?>" name="id" id="id" >
                                            <div class="form-body">
                                                <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="parent_id" class="form-control">
                                                            ...
                                                            <option <?php if($query['parent_id']== $row->id){ echo 'selected'; } ?> value="<?php echo $row->id; ?>"><?php echo $row->attr_name ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" required name="attr_name" value="<?php echo $query['attr_name']; ?>" id="attr_name" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-actions right"><button id="frmSubmit" type="submit" class="btn blue"> <i class="fa fa-check"></i> Save Attribute </button> </div>
                                        </form>
                                    </div>
                                </div>
                            </div>
