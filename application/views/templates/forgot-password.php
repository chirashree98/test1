...
<html lang="en"><head>
        ...
        <style>
            *{padding: 0; margin: 0;}
            body{font-family: "Century Gothic", sans-serif;color: #414347; background: url(<?php echo $site_url; ?>/assets/email_template/images/back.jpg);}
    ...
    <body style='font-family: "Century Gothic", sans-serif;color: #414347; background: url(<?php echo $site_url; ?>/assets/email_template/images/back.jpg);'>
       ...
       <table class="email-template-wid">
            <tr>
                ...
                <th colspan="3" class="logoarea"><img src="<?php echo $site_url; ?>assets/templates/images/logo.png"/></th>
            </tr>
            <tr>
			
<td colspan="3"> <h1 style="margin-top: 30px; font-style: italic;"><?php echo $user['first_name']. " ".$user['last_name']; ?>, here's your OTP</h1></td></tr><tr>
                <td colspan="3"> <h1 style="margin-top: 30px; font-style: italic;">Hello <?php echo $user['first_name']. " ".$user['last_name']; ?></h1>
                    <p>We have received a request to reset the password on your Design Studio Account. </p>
					 <b>OTP <?=@$otp?></b>
...
Design Studio Team.   </p>
             ...
             <tr>
                <td colspan="3" class="template-footer"> 
                    <img src="<?php echo $site_url; ?>/assets/email_template/images/logo2.png"/>
