...
<html lang="en"><head>
    ...
    <body style='font-family: "Century Gothic", sans-serif;color: #414347; background: url(<?php echo $site_url; ?>/assets/email_template/images/back.jpg);'>
        ...
        <table class="email-template-wid">
            ...
            <tr>
                <td colspan="3"> <h1 style="margin-top: 30px; font-style: italic;">Hello <?php echo $dear_name; ?></h1>
                    <p>Thanks for Updating your service profile. </p>
                    <a href="<?php echo $link; ?>"><button class="template-btn">Click to Login</button></a>
