...
<html lang="en"><head>
    ...
    <body style='font-family: "Century Gothic", sans-serif;color: #414347; background: url(<?php echo $site_url; ?>/assets/email_template/images/back.jpg);'>
        ...
        <table class="email-template-wid">
            ...
            <tr>
                <td colspan="3"> <p style="margin-top: 30px">Hello <?php echo $dear_name; ?>;</h1>
                   <p>We are sorry to inform you that your sign-up request is not approved. We will contact you soon.</p>
