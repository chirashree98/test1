...
<body style='font-family: "Century Gothic", sans-serif;color: #414347; background: url(<?php echo $site_url; ?>/assets/email_template/images/back.jpg);'>
    ...
    <table class="email-template-wid">
        ...
        <tr>
            <td colspan="3">
                <h3 style="margin-top: 30px;font-weight:400">Hello Admin,</h3>
                <p>A new message received from <?php echo $message3;?> (DCODE:<?php echo $message2;?>,
                    Email:<?php echo $user_email;?>). </p>
