...
<td colspan="3"> <h1 style="margin-top: 30px; font-style: italic;"> 
    <?php echo $user['first_name']. " ".$user['last_name']; ?>, here's your OTP</h1></td></tr>-->
            <tr>
                <td colspan="3"> <p style="margin-top: 30px">Hello <?php echo $user['first_name'] ?>,</p>
                    <p>We have received a request to reset the password on your Makkan Account. </p>
					 <b>OTP - <?=@$otp?></b>
