...
<html lang="en"><head>
    ...
    <body style='font-family: "Century Gothic", sans-serif;color: #414347; background: url(<?php echo $site_url; ?>/assets/email_template/images/back.jpg);'>
        ...
        <table class="email-template-wid">
            ...
            <tr>
                <td colspan="3"> <p style="margin-top: 30px">Hello User,</p>
				<p>You've been invited to Makkan. </p>
				
                    <p>This is your invitation code is [<?php echo $invitation_code;?>]. Please use this invitation code to get free membership.<a href="<?php echo $invitation_link;?>"> Click here</a></p>
