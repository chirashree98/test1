        ...
        <table class="email-template-wid">
            ...
            <tr>
                <td colspan="3"> <p style="margin-top: 30px">Hello <?php echo $dear_name; ?>,</h1>
                    <p>Thanks for choosing Makkan. We have received your registration request. Before you get started, please verify your email address below </p>
                    <a href="<?php echo $link; ?>"><button class="template-btn">Click to Verify</button></a>
