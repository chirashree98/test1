        ...
        <table class="email-template-wid">
            ...
            <tr>
                <td colspan="3"> <p style="margin-top: 30px">Hello <?php echo $dear_name; ?></h1>
                   <p>Thanks for Signing up with Makkan as a <?php echo $uset_type; ?>. Your registration request in under process. Upon approval of your registration request you will be notified by email.</p>
